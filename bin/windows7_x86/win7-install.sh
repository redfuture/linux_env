...
OPTS="$OPTS -drive id=disk0,if=none,cache=unsafe,format=raw,file=/home/disk4/vm-video-evidence/base-images/windows7.img"
#OPTS="$OPTS -device driver=virtio-scsi-pci,id=scsi0"
#OPTS="$OPTS -device scsi-hd,drive=disk0"

#OPTS="$OPTS -drive id=disk1,if=none,cache=unsafe,format=qcow2,file=/home/disk4/vm-video-evidence/working_images/temp.img"
